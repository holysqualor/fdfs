...
The algorithm (*src/fd.c*) evenly distributes files across the disk, minimizing fragmentation and drive wear. For the algorithm to be most effective, the file system must support extents.


![Algorithm demostration](images/fd.png)
